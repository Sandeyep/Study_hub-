...
class ResourcePage extends StatelessWidget {
        ...
        builder: (context, snapshot) {
            ...
            return Center(
              child: Column(
                ...
                children: [
                  ...
                  TextButton(
                    onPressed: () => _addInstitution(context, userId),
          ...
          return ListView.separated(
            ...
            itemBuilder: (context, index) {
              ...
              return _buildInstitutionCard(context, institution, userId);
            },
          );
        },
      ),
  ...
  Widget _buildInstitutionCard(
    ...
    QueryDocumentSnapshot institution,
    String userId,
  ) {
    return Card(
      elevation: 2,
      ...
      child: ListTile(
        ...
        trailing: PopupMenuButton<String>(
          ...
          onSelected: (value) =>
              _handleInstitutionAction(value, institution, context, userId),
          itemBuilder: (context) => [
            const PopupMenuItem(
              value: 'rename',
  ...
  void _handleInstitutionAction(
    ...
    switch (action) {
      case 'rename':
        _renameInstitution(institution, context, userId);
        break;
      case 'delete':
        _deleteInstitution(institution.id, context, userId);
        break;
    }
  }

  Future<void> _renameInstitution(
    QueryDocumentSnapshot institution,
    BuildContext context,
    String userId,
  ) async {
  ...
  Future<void> _addInstitution(BuildContext context, String userId) async {
